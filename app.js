    ...
    bookList.forEach((book,index)=>{
        ...
        <div class="col-5 ${index%2==0 && "offset-2"} my-5">
          <div class="row book__card">
            <div class="col-6">
              <img class="img-fluid shadow" width="258" height="400" src=${book.imgSource} alt="">
            </div>
            <div class="col-6 d-flex flex-column justify-content-between">
              ...
              <button class="btn__purple p-2" onclick="addBookToBasket(${book.id})">ADD BASKET</button>
            </div>
            </div>
        </div>
        `
...
const listBasketItems=()=>{
    ...
    basketListEl.innerHTML=basketListHtml ? basketListHtml : `<li class="basket__item">No items to Buy again.</li>`
